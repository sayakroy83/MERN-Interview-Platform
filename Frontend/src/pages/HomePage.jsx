    ...
    <div className="bg-gradient-to-br from-base-100 via-base-200 to-base-300">
      ...
      <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
        ...
        <SignInButton mode="modal">
          <button className="group px-6 py-3 bg-gradient-to-r from-primary to-secondary rounded-xl text-white 
          font-semibold text-sm shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 flex items-center gap-2">
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/*RIGHT IMAGE*/}
          <img src="/hero.png" alt="CodeCollab Platform" 
